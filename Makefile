...
coffeetimer: coffeetimer.cpp platform_macos.cpp platform.h utility.cpp utility.h
...
drawtest: drawtest.cpp platform_macos.cpp platform.h utility.cpp utility.h
